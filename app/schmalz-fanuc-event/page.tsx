...
export default function FanucAdsEventPage() {
  ...
  // Set Document Title
  useEffect(() => {
    document.title = 'Registrasi Event Schmalz x Fanuc | PT Dimensi Quantum Wahyudi';
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      eventId: 'schmalz-fanuc', // Identifier to route to the new Ads Google Sheets database
          ...
          <div className="sf-form-column">
            <div className="sf-form-card">
              ...
              {!isSuccess ? (
                ...
                /* Success State Container for Ads Form (No Ticket ID, No Google Calendar) */
                <div className="sf-success-state" style={{ display: 'block' }}>
                  <div className="sf-success-icon-box" style={{ backgroundColor: 'rgba(15, 76, 129, 0.1)', color: 'var(--sf-primary)' }}>
                    <svg fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                  </div>
                  
                  <h2 className="sf-success-title" style={{ color: 'var(--sf-primary)' }}>Registrasi Terkirim</h2>
                  <p className="sf-success-desc" style={{ fontSize: '1rem', lineHeight: '1.6', color: '#475569', marginBottom: '30px' }}>
                    Terima kasih telah melakukan registrasi. Data Anda telah kami catat secara aman. Kami akan segera mengirimkan email konfirmasi resmi beserta undangan keikutsertaan Anda apabila kuota/slot peserta masih tersedia. Terima kasih atas ketertarikan Anda.
                  </p>
