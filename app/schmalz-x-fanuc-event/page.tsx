...
const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbzWg_0WTuYfwVXN_Imn3htE9lEgVsYf-utA_9nHL1vGynfFte_eUb_wL8SIjmd5sHacuA/exec';

export default function FanucEventPage() {
