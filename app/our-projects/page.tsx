...
// Data Source - 15 Verified Deep Research Companies
export const projects = [
    ...
    },
    {
        ...
        logo: 'https://www.nabatisnack.co.id/assets/icons/ic-nabati.png', // Diperbaiki link wikipedianya
        size: 'large',
    ...
    // ---- 21 PROYEK BARU TAMBAHAN (Batch 2) ----
    {
        id: 'pipa-bredero',
    ...
    },
    {
        ...
        size: 'standard',
        desc: 'Akselerasi pengangkatan blok karet masif baling. Mengurangi penggunaan forklift forklift secara berlebihan.',
        color: 'emerald'
    },
    {
        id: 'auto-sugity',
