        ...
        <main className="min-h-screen bg-slate-50 selection:bg-blue-500/30">
            ...
            <section className={`relative ${spacingTokens.hero.standard} overflow-hidden`}>
                ...
                <div className={`${spacingTokens.page.containerMedium} relative text-center z-10`}>
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 border border-slate-200 backdrop-blur-md rounded-full text-blue-700 text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] mb-6 md:mb-8 shadow-sm">
                        <span className="w-2 h-2 rounded-full bg-blue-500 animate-pulse"></span>
                        {copy.badge}
                    </div>

                    <h1 className="text-3xl sm:text-4xl md:text-7xl font-black text-slate-900 leading-[1.1] mb-4 md:mb-6 tracking-tight drop-shadow-sm">
                        {copy.titleLine1} <br />
            ...
            <section className={`${spacingTokens.section.spacious} relative overflow-hidden bg-slate-100 border-t border-slate-200`}>
                <div className={`${spacingTokens.page.containerCompact} max-w-3xl text-center relative z-10`}>
                    <div className="bg-white border border-slate-200 p-3 sm:p-4 inline-block rounded-3xl mb-6 md:mb-8 shadow-sm">
                        <CheckCircle size={40} className="text-blue-500" />
                    </div>
                    <h2 className="text-2xl sm:text-3xl md:text-5xl font-black text-slate-900 mb-4 md:mb-6 drop-shadow-sm">{copy.ctaTitle}</h2>
                    <p className="text-slate-600 text-base md:text-lg mb-8 md:mb-10 leading-relaxed font-light">
                        {copy.ctaDesc}
                    </p>
                    <Link href="/contact" className="inline-flex items-center gap-3 px-7 sm:px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-2xl transition-all hover:scale-105 active:scale-95 shadow-md shadow-blue-600/20">
