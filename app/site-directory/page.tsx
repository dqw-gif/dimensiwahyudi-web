  ...
  const structure = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: '↳ Vacuum Lifting Devices (VacuMaster)', href: '/products/schmalz/vacumaster' },
        { name: '↳ Crane Systems & Jib Cranes', href: '/products/schmalz/crane-system' },
        { name: '↳ Mobile Lifting Devices', href: '/products/schmalz/mobile-lifting-device' },
        { name: '↳ Vacuum Generators & Ejectors', href: '/products/schmalz/vacuum-generator' },
        { name: '↳ Vacuum Suction Cups', href: '/products/schmalz/vacuum-suction-cups' },
